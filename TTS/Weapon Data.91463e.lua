function onLoad()
    ...
    underslungGrenadeLauncher = {
        ...
        shortRange = {range = 12, mWModifier = 0, Damage = 11},
        longRange = {range = 36, mWModifier = -2, Damage = 11},
        damageMultiplier = 1,
        critFail = 18
    }
    m606LMG = {
    ...
    soullessShriek = {
        Name = "Soulless Shriek",
        longRange = {range = 8, mWModifier = 2, Damage = 10},
        shortRange = {range = 8, mWModifier = 2, Damage = 10},
        specialAbilities = {
            Symmetry = 1,
            Projected = 1,
            Concussive = 1
    ...
    soulshearer = {
        Name = "Soulshearer",
        longRange = {range = 12, mWModifier = 0, Damage = 5},
        shortRange = {range = 36, mWModifier = -2, Damage = 5},
        specialAbilities = {
            Vicious = 1,
            Terrifying = 1,
            Horryfing = 3
