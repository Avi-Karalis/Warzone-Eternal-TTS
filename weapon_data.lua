weapon_data ={
    ...
    cSA404Sword ={
        Name = "CSA-404 Sword",
        cCModifier = 1,
        cCDamage = function(ST) return 6 + ST end,
        specialAbilities = {
            Reach = 1,
            Vicious = function (W) return W * 2 end
        },
        critFail = 20,
        damageMultiplier = 1
    },
    ...
    bladeBayonet = {
        Name = "Blade / Bayonet",
        cCModifier = 0,
        cCDamage = function(ST) return 5 + ST end,
        specialAbilities = {
            Thrust = 3
        },
        damageMultiplier = 1,
    ...
    gasGrenades = {
        Name = "Gas Grenades",
        shortRange = {range = 0, mWModifier = 0, Damage = 0},
        longRange = {range = function(ST) return 4 + ST end, mWModifier = -1, Damage = 9},
        specialAbilities = {
            Cloud = 2,
            Smoke = 1,
            Continous = 1,
    ...
    fragGrenades = {
        Name = "Frag Grenades",
        shortRange = {range = 0, mWModifier = 0, Damage = 0},
        longRange = {range = function(ST) return 4 + ST end, mWModifier = -1, Damage = 11},
        specialAbilities = {
            Explosive = 2,
            Indirect = 1
        },
    ...
    plasmaGrenades = {
        ...
        shortRange = {range = 0, mWModifier = 0, Damage = 0},
        longRange = {range = function(ST) return 4 + ST end, mWModifier = -1, Damage = 12},
        specialAbilities = {
            Explosive = 1,
            Continous = 1,
            Indirect = 1
